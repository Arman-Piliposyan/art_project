...
import { postLinkedinToken } from '/src/services/linkedinService';
import { Colors } from '/src/globalStyles/colors';

const IntegrationLinkedinPage = () => {
...
export default IntegrationLinkedinPage;
