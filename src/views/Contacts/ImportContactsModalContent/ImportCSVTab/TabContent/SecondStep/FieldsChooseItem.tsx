...
export const FieldsChooseItem = ({ columnData, index }: Props) => {
  const { defaultFieldsOptions, setImportCSVTabData, importCSVTabData } = useImportContactsContext();
  ...
  const handleChange = (event: SelectChangeEvent) => {
    ...
    setImportCSVTabData({
      ...importCSVTabData,
      step2: {
        ...importCSVTabData.step2,
        columnMappings: [
          ...importCSVTabData.step2.columnMappings.slice(0, index),
          { ...importCSVTabData.step2.columnMappings[index], simulacrumType: event.target.value },
          ...importCSVTabData.step2.columnMappings.slice(index + 1),
        ],
      },
    });
  };
      ...
      >
        <FormControl sx={{ width: '90%' }} size="small">
          <Select
            sx={{
              backgroundColor:
                importCSVTabData.step2.columnMappings[index].simulacrumType === 'not_mapped'
                  ? '#fff8eb'
            ...
            value={importCSVTabData.step2.columnMappings[index].simulacrumType || ''}
